...
RSpec.describe Advertisement, type: :model do
  it 'should have valid Factory' do
    ...
    # puts user.id
    expect(create(:advertisement)).to be_valid
  end
  ...
  describe '#advert creation' do
    ...
    it 'it should not allow advert without location to be created' do
      advertisement = build(:advertisement, location: '')
      advertisement.save
    ...
    it 'it should not allow advert with long location to be created' do
      advertisement = build(:advertisement, location: 'Kingston'*4)
      advertisement.save
    ...
    it 'it should not allow advert without category to be created' do
      advertisement = build(:advertisement, category: '')
      advertisement.save
    ...
    it 'it should not allow advert with long category to be created' do
      advertisement = build(:advertisement, category: 'Electronics'*4)
      advertisement.save
    ...
    it 'it should not allow advert without advert_type to be created' do
      advertisement = build(:advertisement, advert_type: '')
      advertisement.save
    ...
    it 'it should not allow advert with long advert_type to be created' do
      advertisement = build(:advertisement, advert_type: 'Computer'*4)
      advertisement.save
    ...
    it 'it should not allow advert without price to be created' do
      advertisement = build(:advertisement, price: '')
      advertisement.save
    ...
    it 'it should not allow advert with non integer price to be created' do
      advertisement = build(:advertisement, price: 'a1')
      advertisement.save
